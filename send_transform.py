...
def callback_cam(pc2_msg): 
    ...
    # Different method (open3d-ros-helper)
    # ros_transform = orh.se3_to_transform(T_btw_cameras)
    # o3dpc = orh.do_transform_point(o3dpc, ros_transform)

    # o3dpc = o3dpc.voxel_down_sample(voxel_size=0.02)
